...
@Database(entities = [Task::class, Category::class, SubTask::class], version = 2, exportSchema = false)
@TypeConverters(LocalDateConverter::class, LocalDateTimeConverter::class, ListConverter::class)
